...
urlpatterns = [
    ...
    path('api/coords_para_endereco/', viewsOperacional.coords_para_endereco, name='coords_para_endereco'),
    ...
    path('get_ocorrencias_dtc/',viewsOperacional.GetOcorrenciasDtc.as_view(),name='GetOcorrenciasDtc'),
