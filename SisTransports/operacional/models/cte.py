...
class Cte(models.Model):
    ...
    def to_dict(self):
        ...
        Returns:
            dict: Dicionário contendo os dados do Cte.
        """
        return {
            'id': self.id,
            ...
            'data_cadastro': self.data_cadastro.strftime('%Y-%m-%d %H:%M:%S') if self.data_cadastro else '01/01/2001',
    ...
    def save(self, *args, **kwargs):
        """
        Sobrescreve o método save para atualizar a data de última atualização.
        """
        self.data_ultima_atualizacao = datetime.now()
        super(Cte, self).save(*args, **kwargs)
